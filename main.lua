...
opts = {
    ...
    fixedHeight = false,    -- set true to allow osc to scale with window
...
-- logo and message are constructed in expansion.lua
...
-- enviroment updater
-- this element updates shared variables, sets active areas and starts event generators
local env
env = newElement('env')
env.layer = 1000
env.visible = false
...
ne.geo.h = 1
ne.geo.an = 8
-- DO NOT directly assign a shared style table!
